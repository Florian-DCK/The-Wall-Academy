  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch("/api/connect", {
      ...
      .then(async (response) => {
        ...
        if (response.ok) {
          router.push(`/${locale}/gallery/view?page=1`);
        } else {
  ...
  return (
    <main className="relative flex flex-1 w-full items-center justify-center px-4 py-12">
      <div className="glass-panel relative mx-auto flex w-full max-w-5xl flex-col gap-10 rounded-3xl px-6 py-10 sm:px-10">
        <nav className="flex items-center justify-center gap-6 text-sm font-semibold uppercase tracking-[0.15em] text-white/80">
