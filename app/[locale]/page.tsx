		...
		<main className="overflow-x-hidden">
			<section id="landing" className="h-screen bg-black grid grid-cols-2">
				...
				<div className="flex items-center lg:justify-end">
					<Image
						...
						height={1080}
						alt={'Vincent Vanasch'}
						className="h-full lg:h-full lg:w-auto object-cover object-right"
					/>
				</div>
				<div className="flex flex-col justify-center gap-5">
					<p className="text-xl lg:text-8xl font-extrabold uppercase leading-4 lg:leading-18 text-white">
						{t.rich('title', {
							br: () => <br />,
							highlight: (chunks) => (
			...
			<section
				...
				<div className="order-2 flex flex-col overflow-hidden gap-8 lg:order-1">
					...
					<Button
						className={
							'w-fit self-end  text-lg font-bold shadow-none tracking-tight'
						}>
						{t('CTA')}
					</Button>
				</div>
				<div className="order-1 relative  flex h-lvh lg:h-full flex-col justify-center bg-[rgb(253, 253, 253)] lg:order-2">
					<Image
						src={'/naked_VV.png'}
